...
public class ProfileProcessor {
    ...
    private ArrayList<Security> toSuggest;

    
    /**
     * Create a new profile processor.
     * @param profile   the client's profile
     * @param iO        investment objectives
     * @param rT        risk tolerance
     * @param tH        time horizon
     * @param lN        liquidity need
     */
    public ProfileProcessor(ClientProfile profile, ArrayList<Security> secs) {
     ...
     */
    public void suggestInvestments() {
        /*
        ...
        //this.editListFromTRLPreferences(timeHorizon);
     ...
     */
    public ArrayList<Security> getToSuggest() {
